...
public:
    ...
    */
    ...
    /** Helper method to print a more detailed information on the
        given path.

        \param[in] path The path generated by this object via a call
        to findBestPath method(s).

        \param[out] os The output stream to where the detailed path
