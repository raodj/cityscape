...
protected:
    ...
    */
    ...
    /**
       Helper method load the TSV file generated by the risk analyzer.
       This method loads the ways and nodes from the given
       waysRiskFile and plots it.  This method assumes that the data
       is in a specific columnar format.

       \param[in] waysRiskFile The risk file from where the data is to
       be read.

       \param[out] xfig The XFig stream to where the risk information
       is to be written.

       \param[in] stLevel The starting level to where the data is to
       be written.
    */
    ...
    */
    ...
    public:
        ...
        */
        ...
        /** A TSV file containing the output from risk_analyzer from
           where vertifices and ways for risk analysis are to be
           ploted.
        */
