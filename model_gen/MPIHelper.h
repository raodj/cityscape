...
/** \file MPIHelper.h
    ...
    code so that software can be built with and without MPI.

    This header file has been introduced to permit to compile with and
    without the presence of MPI. The code is designed in such a way to
    enable the use of MPI without hurting the readability and
    development.
*/
